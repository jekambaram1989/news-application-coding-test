...
@Composable
fun NewsScreen(
    navController: NavController, contentPadding: PaddingValues, viewmodel: HomeViewmodel
) {
    val uiEvent by viewmodel.news.collectAsState()
    Column(
        modifier = Modifier
        ...
        when (uiEvent) {
            ...
            is NewsUiEvent.Success -> {
                ...
                ScrollableTab(navController, uiEvent.news!!)
            }
        }
    }
}